...
export class ServiceTracking {
  ...
  @Column({ name: 'id_reporte_entrega_servicios', length: 255, nullable: true })
  ...
  @Column({ name: 'id_certificado', length: 255, nullable: true })
  idCertificado: string;

  @Column({ name: 'fecha_entrega_certificado', type: 'date', nullable: true })
  fechaEntregaCertificado: Date;

  @Column({ name: 'id_factura', length: 255, nullable: true })
  idFactura: string;
  ...
  @Column({ name: 'comprobante_egreso', length: 255, nullable: true })
